...
Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - DINE-IN'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.Button - PASTRIES'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - PASTRIES'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.Button - TRIPLE CHOCO BROWNIES'), 
    0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - TRIPLE CHOCO BROWNIES'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.TextView - Triple Choco Brownies'), 
    0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.TextView - Triple Choco Brownies'), 0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.Button - ATHLETES DISCOUNT'), 
    0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - ATHLETES DISCOUNT'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - PAYMENT'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - PAYMAYA'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.EditText - REF NO'), 0)

Mobile.setText(findTestObject('Object Repository/Transactions/android.widget.EditText - REF NO'), '454545454554', 0)

Mobile.setText(findTestObject('Object Repository/Transactions/android.widget.EditText - CUS NAME'), 'Erwin', 0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.Button - OK'), 0)
