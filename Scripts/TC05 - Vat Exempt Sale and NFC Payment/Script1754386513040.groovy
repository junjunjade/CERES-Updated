...
Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - PIZZA SLICE'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - NY PEPPERONI'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - NY SBREMO'), 0)
...
Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - VAT EXEMPT SALE'), 0)

Mobile.setText(findTestObject('Object Repository/Transactions/android.widget.EditText - Name'), 'Rene Boy', 0)

Mobile.setText(findTestObject('Object Repository/Transactions/android.widget.EditText - Address'), '98 Q Ave', 0)
...
Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - NFC'), 0)

Mobile.setText(findTestObject('Object Repository/Transactions/android.widget.EditText'), '2424242424242', 0)
