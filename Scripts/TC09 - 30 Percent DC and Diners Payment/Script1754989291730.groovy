...
Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.Button - 30 OTHER DISCOUNT'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - 30 OTHER DISCOUNT'), 0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.Button - DINERS'), 0)
Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - DINERS'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.EditText - REF NO'), 0)

Mobile.setText(findTestObject('Object Repository/Transactions/android.widget.EditText - REF NO'), '1892831', 0)

Mobile.setText(findTestObject('Object Repository/Transactions/android.widget.EditText - CUS NAME'), 'MC', 0)
