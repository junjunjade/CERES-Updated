...
Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - NEW RICE PARMIGIANA'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.TextView - NEW RICE PARMIGIANA'), 
    0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.TextView - NEW RICE PARMIGIANA'), 0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.Button - PWD'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - PWD'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.EditText - Name'), 0)

Mobile.setText(findTestObject('Object Repository/Transactions/android.widget.EditText - Name'), 'Echo Nol', 0)

Mobile.setText(findTestObject('Object Repository/Transactions/android.widget.EditText - ID No'), '123456', 0)
...
Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - WECHAT'), 0)

Mobile.setText(findTestObject('Object Repository/Transactions/android.widget.EditText'), '123456789', 0)
