...
Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.Button - CHICKEN MEAL'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - CHICKEN MEAL'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.Button - CHICKEN PARM-REG-SPAG'), 
    0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - CHICKEN PARM-REG-SPAG'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - SALADS'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.Button - CEASAR SALAD'), 0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.Button - GCASH'), 0)
...
Mobile.setText(findTestObject('Object Repository/Transactions/android.widget.EditText - REF NO'), '1234567890987', 0)

Mobile.setText(findTestObject('Object Repository/Transactions/android.widget.EditText - CUS NAME'), 'Lei Sulongsawa', 0)
