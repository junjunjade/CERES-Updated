...
Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - CHICKEN PESTO PASTA'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - DISCOUNT'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - 50 OTHER DISCOUNT'), 0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.Button - MASTER CARD DEBIT'),
	0)
Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - MASTER CARD DEBIT'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.EditText - REF NO'), 0)

Mobile.setText(findTestObject('Object Repository/Transactions/android.widget.EditText - REF NO'), '213893721', 0)

Mobile.setText(findTestObject('Object Repository/Transactions/android.widget.EditText - CUS NAME'), 'Match', 0)
