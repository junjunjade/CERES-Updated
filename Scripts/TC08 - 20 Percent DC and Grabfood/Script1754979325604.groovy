...
Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.Button - DINE-IN'),
	0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.Button - PIZZA NEW 8 INCHES'), 
    0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - PIZZA NEW 8 INCHES'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.Button - NY WHITE 8 INCHES'), 
    0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - NY WHITE 8 INCHES'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - NY MUSHROOM 8 INCHES'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - NY PEPPERONI 8 INCHES'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - DISCOUNT'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.Button - 20 OTHER DISCOUNT'), 
    0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - 20 OTHER DISCOUNT'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - PAYMENT'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.Button - GRAB FOOD'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - GRAB FOOD'), 0)

Mobile.setText(findTestObject('Object Repository/Transactions/android.widget.EditText - REF NO'), '435332', 0)
