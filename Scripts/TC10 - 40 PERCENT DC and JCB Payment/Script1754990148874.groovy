...
Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.Button - PIZZA WHOLE'), 0)
Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - PIZZA WHOLE'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.Button - CHICAGO ALL MEAT'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - CHICAGO ALL MEAT'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - NY CHEESE'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - DISCOUNT'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.Button - 40 OTHER DISCOUNT'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - 40 OTHER DISCOUNT'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - PAYMENT'), 0)

Mobile.tap(findTestObject('Object Repository/Transactions/android.widget.Button - JCB'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Transactions/android.widget.EditText - REF NO'), 0)

Mobile.setText(findTestObject('Object Repository/Transactions/android.widget.EditText - REF NO'), '45644890', 0)
